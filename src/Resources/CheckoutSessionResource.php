...
final class CheckoutSessionResource extends ApiResource
{
    ...
    {
        return CheckoutSession::from($this->client->post($this->resourceUri(), $this->withDefaultCurrency($params), $this->idempotencyHeader($idempotencyKey)));
    }
    ...
    {
        return CheckoutSession::from($this->client->post("{$this->resourceUri()}/{$id}/expire", [], $this->idempotencyHeader($idempotencyKey)));
    }
}
