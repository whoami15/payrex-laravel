...
final class PaymentIntentResource extends ApiResource
{
    ...
    {
        return PaymentIntent::from($this->client->post($this->resourceUri(), $this->withDefaultCurrency($params)));
    }
    ...
    {
        return PaymentIntent::from($this->client->post("{$this->resourceUri()}/{$id}/cancel"));
    }
    ...
    {
        return PaymentIntent::from($this->client->post("{$this->resourceUri()}/{$id}/capture", $params));
    }
}
