...
final readonly class BillingStatement extends PayrexObject
{
    public function __construct(
        ...
        /** @var list<BillingStatementLineItem>|null */
    ...
    public static function from(array $attributes): static
    {
        return new self(
            ...
            lineItems: isset($attributes['line_items']) ? array_values(array_map(
                fn (array $item): BillingStatementLineItem => BillingStatementLineItem::from($item),
