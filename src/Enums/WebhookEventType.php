...
enum WebhookEventType: string
{
    ...
    case PaymentIntentAmountCapturable = 'payment_intent.amount_capturable';
    ...
    public function eventClass(): string
    {
        return match ($this) {
            ...
            self::PaymentIntentAmountCapturable => PaymentIntentAmountCapturable::class,
            self::CashBalanceFundsAvailable => CashBalanceFundsAvailable::class,
