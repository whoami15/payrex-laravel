...
function sendSignedWebhook(TestCase $test, array $payload): TestResponse
{
    ...
    return $test->call(
        ...
        [
            ...
            'HTTP_PAYREX_SIGNATURE' => buildWebhookSignature($json, $secret),
        ],
        $json
    );
}
...
it('dispatches correct event class for each event type', function (string $type, string $class) {
    ...
    ['payment_intent.amount_capturable', PaymentIntentAmountCapturable::class],
    ['cash_balance.funds_available', CashBalanceFundsAvailable::class],
...
it('dispatches event with correct payload data', function () {
    ...
    $payload = [
        ...
        'type' => 'payment_intent.succeeded',
        'livemode' => false,
        'data' => ['id' => 'pi_payload_123', 'resource' => 'payment_intent', 'amount' => 50000],
    ];
...
it('dispatches event with live mode signature', function () {
    ...
    $payload = [
        ...
        'type' => 'payment_intent.succeeded',
        'livemode' => true,
        'data' => ['id' => 'pi_live_123', 'resource' => 'payment_intent'],
    ];
...
it('rejects malformed JSON payload', function () {
    ...
    $response->assertSee('Empty webhook payload');
});
