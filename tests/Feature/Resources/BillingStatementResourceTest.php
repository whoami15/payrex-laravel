...
it('retrieves a billing statement', function () {
    Http::fake(['https://api.payrexhq.com/billing_statements/bstm_AbvnRnF9r577BBFFuNsLFvXvLes1CeeS' => Http::response(loadFixture('billing_statement/finalized.json'))]);
...
it('sends a billing statement and returns the resource', function () {
    Http::fake([
        'https://api.payrexhq.com/billing_statements/bstm_AbvnRnF9r577BBFFuNsLFvXvLes1CeeS/send' => Http::response(loadFixture('billing_statement/finalized.json')),
    ]);
...
it('sends a billing statement and retrieves when API returns empty response', function () {
    Http::fake([
        'https://api.payrexhq.com/billing_statements/bstm_AbvnRnF9r577BBFFuNsLFvXvLes1CeeS/send' => Http::response([]),
        'https://api.payrexhq.com/billing_statements/bstm_AbvnRnF9r577BBFFuNsLFvXvLes1CeeS' => Http::response(loadFixture('billing_statement/finalized.json')),
    ]);
